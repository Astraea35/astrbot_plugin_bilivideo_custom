...
class PluginConfig:
    ...
    summary_featured_comment_count: int = 2
    ...
    def from_mapping(cls, raw: Mapping[str, Any]) -> PluginConfig:
        ...
        return cls(
            ...
            enable_bilibili_ai_subtitle=_coerce_bool(
                flat.get("enable_bilibili_ai_subtitle"), True
            ),
            summary_featured_comment_count=_coerce_int(
                flat.get("summary_featured_comment_count"), 2, lo=0, hi=5
            ),
            summary_comment_reply_count=_coerce_int(
                flat.get("summary_comment_reply_count"), 1, lo=0, hi=3
            ),
