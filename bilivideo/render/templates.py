...
.featured-comments { display: grid; gap: 20px; }
.comment-count { margin-left: 10px; color: #64748b; font-size: 16px; font-weight: 500; }
.featured-comment { padding-top: 18px; border-top: 1px solid var(--border); }
.featured-comment:first-child { padding-top: 0; border-top: 0; }
