...
async def render_note_components(services: BiliVideoServices, markdown_text: str) -> list[Any] | str:
    """通用 AI 总结 Markdown 转长图浏览器组件"""
    try:
        return await _render_note_components_inner(services, markdown_text)
...
async def _render_note_components_inner(services: BiliVideoServices, markdown_text: str) -> list[Any] | str:
